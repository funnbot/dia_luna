...
{
    public override Transition GetInitialState() => To<State.Unsynced>();
    ...
    public abstract record State : StateLogic<State>
    {
        ...
        {
            public Transition On(in Input.Synchronized input) => To<Idle>();
        }
                ...
                IGet<Input.PhysicsTick>
        {
            ...
            public Transition On(in Input.PhysicsTick input) => ToSelf();
        }
    }
}
...
public partial class NavAgentComponent : NavigationAgent2D
{
    ...
    private void ComputeVelocity()
    {
        ...
        var velocity = VelocityComponent.GlobalPosition.DirectionTo(nextPos) * MoveSpeed;
        if (AvoidanceEnabled)
        {
            Velocity = velocity;
        }
    ...
    private void OnVelocityComputed(Vector2 safe_velocity) => VelocityComponent.TargetVelocity = safe_velocity;
