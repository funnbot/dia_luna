...
#pragma warning restore CA1711
{
    ...
    public readonly ItemStack CopyWithQuantity(int quantity) => new(Definition, quantity);
...
{
    private ItemSlot[] ItemSlots { get; }
    ...
    public bool TryMergeStack(int index, ref ItemStack incomingStack) => ItemSlots[index].TryMergeStack(ref incomingStack);

    public bool TryPickupStack(int index, out ItemStack incomingStack) => ItemSlots[index].TryPickupStack(out incomingStack);
